                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="tos_legal_age">
                                <div class="row">
                                    <div class="col-auto">
                                        <div>1.</div>
                                    </div>
                                    <div class="col">
                                        You must be of <span class="tos_span">legal age.</span> If not, additional
                                        consent from a legal guardian is required.
                                    </div>
                                </div>
                            </label>
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="tos_free_initial">
                                <div class="row">
                                    <div class="col-auto">
                                        <div>2.</div>
                                    </div>
                                    <div class="col">
                                        <span class="tos_span">FREE INITIAL CHECK-UP-</span>limited to Physical and
                                        Basic Troubleshooting.
                                    </div>
                                </div>
                            </label>
                            <!-- Additional checkboxes for Number 2 -->
                            <div class="form-check-nested">
                                <input class="form-check-input" type="checkbox" value="" id="tos_advanced_diagnostic">
                                <label class="form-check-label" for="tos_advanced_diagnostic">
                                    <span class="tos_span">Advanced diagnostic Check-up-procedures-</span> are required
                                    to address the issues that necessitate deep troubleshooting.
                                </label>
                            </div>
                            <div class="form-check-nested">
                                <input class="form-check-input" type="checkbox" value="" id="tos_rush_fee">
                                <label class="form-check-label" for="tos_rush_fee">
                                    <span class="tos_span">RUSH FEE</span> - A rush fee is applicable for urgent repair
                                    units. Kindly coordinate with the responsible technician to facilitate the process.
                                </label>
                            </div>
                            <!-- End of additional checkboxes for Number 2 -->
                        </div>
                    </div>
                </div>
