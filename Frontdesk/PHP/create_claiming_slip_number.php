...
if(isset($_GET['cid_number']) && !empty($_GET['cid_number'])) {
    ...
    $sql_cids = "SELECT cid.*, technicians.csu_name AS technician_name, services_type.cs_service_name AS service_name, claiming_slip.cid_cs_color,  claiming_slip.cid_cs_accesories, 
